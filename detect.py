...
class Predictor:
    ...
    def run_inference(self):
        ...
        image_path = os.path.join("user_data/input","inputImage.jpg")
        ...
        os.makedirs("user_data/output", exist_ok=True)
        
        output_file_path = 'user_data/output/output.jpg'
        cv2.imwrite(output_file_path, image_np)
        opencodedbase64 = encodeImageIntoBase64(output_file_path)
        #listOfOutput = []
